...
from .views import QuadregisterView,QuadContestsView,\
    QuadContestView,QuadContestProblemsView,QuadContestProblemView,\
        QuadSelfContests,QuadContestApply, QuadContestProblemPickleView
urlpatterns=[
    ...
    path('contests/<uuid:contest_uuid>/problems/<uuid:problem_uuid>/pickle/',QuadContestProblemPickleView.as_view(),name='quadcontestproblempickle'),
