...
from .views  import ContestsView,ApplyContest,ContestView,AttemptContest,ProblemsView,\
    ProblemView,AnswerView, SubmissionsView,StandingsView, FriendsStandingsView
urlpatterns = [
    ...
    path('contests/<uuid:contest_uuid>/friendsstandings/',FriendsStandingsView.as_view(),name='contest_standings_friends'), #depending on the score in contestproceess
