...
import { 
    QuadrantContestState,QuadContestPatchState,QuadContestState,QuadProblemCreateState,QuadProblemsState, QuadProblemPatchState, QuadProblemDeleteState } from './state';
...
export const mutations = {
    ...
    setQuadrantProblemDelete(state: QuadrantContestState,payload:QuadProblemDeleteState){
        state.problemDeleteState = payload;
    },
...
export const commitSetQuadrantProblemDelete = commit(mutations.setQuadrantProblemDelete);
